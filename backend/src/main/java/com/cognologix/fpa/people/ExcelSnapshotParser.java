...
/**
 * Parses Zoho Excel exports into row maps keyed by system attribute (ADR-019).
 */
@Component
public class ExcelSnapshotParser {
    ...
    public static String required(Map<String, String> row, String attribute) {
        ...
        if (v == null || v.isBlank()) {
            throw new BadRequestException("Missing required mapped value: " + attribute);
        }
        return v.trim();
    }
    ...
    public static BigDecimal requiredDecimal(Map<String, String> row, String attribute) {
        ...
        try {
            ...
            if (amount == null) {
                throw new BadRequestException("Invalid number for " + attribute + ": " + v);
            }
            // Zoho Payroll exports full rupees; store as Rs Lakhs (ADR-046).
    ...
    public static LocalDate optionalDate(Map<String, String> row, String attribute) {
        ...
        if (parsed == null) {
            throw new BadRequestException("Invalid date for " + attribute + ": " + v);
        }
        return parsed;
    }
    ...
    /** Alias used by exit upload — same as {@link SystemAttribute#LAST_WORKING_DAY}. */
    public static final String LAST_WORKING_DAY = SystemAttribute.LAST_WORKING_DAY;
